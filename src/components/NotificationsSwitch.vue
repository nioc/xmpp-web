<template>
  <div v-if="isNotificationsSupported">
    <o-switch v-model="hasNotificationsEnabledSwitch" title="Allow the browser to send you notifications when you miss messages" class="has-no-wrap"><span class="icon mr-1"><i class="fa-regular fa-bell fa-fw" aria-hidden="true" /></span>Notifications</o-switch>
  </div>
</template>
